...
function Navbar() {
  return (
    <div>
        <nav id="header" className="fixed w-full z-30 top-0 text-black font-extrabold">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
          ...
          <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
            <ul className="list-reset lg:flex justify-end flex-1 items-center">
              <li className="mr-3">
                <Link className="inline-block py-2 px-4 text-black font-bold no-underline nav-link hover:underline" href='/'>Home</Link>
              </li>
              <li className="mr-3">
                <Link className="inline-block text-black no-underline hover:text-gray-800 hover:underline py-2 px-4" href="/about">About</Link>
              </li>
              <li className="mr-3">
                <Link className="inline-block text-black no-underline hover:text-gray-800 hover:underline py-2 px-4" href="/price">Price</Link>
              </li>
            </ul>
