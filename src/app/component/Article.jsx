...
export default function Article() {
    return (
        <div>
            <section className="bg-white border-b mt-0 pb-8">
            ...
            <section className="bg-white border-b py-8">
                <div className="container md:max-w-[1200px] mx-auto flex flex-col flex-wrap pt-4 pb-12">
                    <h2 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
                        Title
                    </h2>
                    <div className="w-full mb-4">
                    ...
                    <div className="flex md:flex-row flex-col">
                        <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink transition-all duration-150 hover:scale-110">
