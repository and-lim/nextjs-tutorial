...
export default function Hero(props) {
  ...
  return (
    <>
      <div className="pt-28 min-h-[90vh] gradient">
        <div className="container px-3 mx-auto w-full lg:max-w-7xl flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <p className="leading-normal text-2xl mb-8">{message}</p>
            <button className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
              Subscribe
            </button>
          </div>
          <div className="w-full md:w-3/5 py-6 text-center">
            <img className="w-full relative lg:left-44 md:w-4/5 z-50" src="hero.png" />
          </div>
        </div>
      </div>

      <div className="relative -top-[75px]  lg:-top-[180px]">
        <svg
...
//   const title = 'Main Hero message';
//   const message = ' Sub-hero message, not too long and not too short. Make it just right';
